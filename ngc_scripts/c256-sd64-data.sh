...
--commandline "mkdir DSNO-code; cd DSNO-code; git clone https://github.com/devzhk/stable-diffusion.git; cd stable-diffusion; git pull; sleep 2; \
...
--result /results --workspace T3_Ez80ySDWgSGnN26jtOg:/ --port 6006 --port 1234 --port 8888
